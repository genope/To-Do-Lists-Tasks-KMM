...
import todolist.kmm.presentation.view.features.task_add.AddTaskScreen
import todolist.kmm.presentation.view.features.task_details.TaskDetailsScreen
import todolist.kmm.presentation.view.features.tasks_favorites.TasksFavoritesScreen
...
class TaskScreen : Screen {
    ...
    override fun Content() {
        ...
        Scaffold(
            topBar = {
                ActionAppBar { taskViewModel.setEvent(TasksContrant.Event.OnAddTaskClick) }
            },
        ) { padding ->
